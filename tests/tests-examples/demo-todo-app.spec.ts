...
import { TodoAppPage } from '../lib/page/todo-app.page';
...
test.describe('New Todo', () => {
  test('should allow me to add todo items', async ({ page }) => {
    // --- Sample Page Object Model Usage ------------------------ //
    
    // Create 1st todo & Make sure the list only has one todo item.
    const todoApp = new TodoAppPage(page);
    await todoApp.createFirstTodo(TODO_ITEMS[0])

    // Create 2nd todo & Make sure the list now has two todo items.
    await todoApp.createSecondTodo(TODO_ITEMS[0],TODO_ITEMS[1]);
